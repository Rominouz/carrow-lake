...
window.CL_HYBRID_SCENES[3]={
  backgrounds:{
    room:'./assets/scenes/03/scene-03-room.webp',
    window:'./assets/scenes/03/scene-03-window.webp',
    bathroom:'./assets/scenes/03/scene-03-bathroom.webp',
    cemetery:'./assets/scenes/04/scene-04-cemetery.webp',
    road:'./assets/scenes/03/scene-03-road.webp'
  },
